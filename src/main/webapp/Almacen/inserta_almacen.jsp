...
<main class="main">
    <div class="container">
        <br/><br/><form method="post" action="/LibreriaCientifica/InsertaAlmacen">
            <p>Código Repisa <input type="text" name = "codRepisa" class="field"></p>
            <p>Numero de Ejemplares <input type="text" name = "numeroEjemplares" class="field"></p>
            <p>Pasillos <input type="text" name = "pasillosA" class="field"></p>
