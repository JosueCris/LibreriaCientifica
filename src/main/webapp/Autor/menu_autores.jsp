    ...
    <div class="container logo-nav-container">
        ...
        <nav class="navigation">
            <ul class="show">
                ...
                <li><a href="/LibreriaCientifica/Cargo/menu_cargo.jsp">Cargo</a></li>                <%--                <li><a href="/XMenWebProject/presentations/menu_presentations.html">Presentaciones</a></li>--%>
...
<main class="main">
    <div class="container">
        <br/><h1>Autor</h1>
        <p>Es la o las personas responsables del concepto y la escritura de uno o muchos libros. Esa persona concibe en su mente la creación y luego la plasma o expresa en dicha pieza literaria.</p>
        <br>
        <form class="center" action="/LibreriaCientifica/Autor/autores.jsp">
            <input type="submit" class=" opc opc-green" value="Lista de Autores">
        </form><br>

        <form class="center" action="/LibreriaCientifica/Autor/inserta_autores.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Autor">
        </form><br>
        <form class="center" action="/LibreriaCientifica/Autor/update_autor.jsp">
            <input type="submit" class=" opc opc-green" value="Actualiza Autor">
        </form>
