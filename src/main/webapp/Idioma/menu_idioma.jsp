...
<main class="main">
    <div class="container">
        <br/><h1>Idioma</h1>
        <p>Los libros que tenemos, estan traducidos en otros idiomas, para personas que son de otros países, o porque se importan de otros lugares del mundo.</p>
        <br>
        <form class="center" action="/LibreriaCientifica/Idioma/idioma.jsp">
            <input type="submit" class=" opc opc-green" value="Lista de Idiomas">
        </form><br>

        <form class="center" action="/LibreriaCientifica/Idioma/inserta_idioma.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Idioma">
        </form><br>
        <form class="center" action="/LibreriaCientifica/Idioma/update_idioma.jsp">
            <input type="submit" class=" opc opc-green" value="Actualiza Idioma">
        </form>
