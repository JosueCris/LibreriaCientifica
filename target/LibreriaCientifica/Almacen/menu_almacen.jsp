...
<main class="main">
    <div class="container">
        <br/><h1>Almacen</h1>
        <p>Nos referimos al espacio fisico en donde se encuentran ubicados cada uno de nuestros libros para una mejor gestion y organizacion a la hora de manipularlos.</p>
        <br>
        <form class="center" action="/LibreriaCientifica/Almacen/almacen.jsp">
            <input type="submit" class=" opc opc-green" value="Lista de Almacen">
        </form><br>

        <form class="center" action="/LibreriaCientifica/Almacen/inserta_almacen.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Almacen">
        </form><br>
        <form class="center" action="/LibreriaCientifica/Almacen/update_almacen.jsp">
