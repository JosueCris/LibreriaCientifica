...
<main class="main">
    <div class="container">
        <br/><h1>Cargo</h1>
        <p>Es el rol que la persona perteneciente a la libreria se encarga de desempeñar en su horario de trabajo correspondiente.</p>
        <br>
        <form class="center" action="/LibreriaCientifica/Cargo/cargo.jsp">
            <input type="submit" class=" opc opc-green" value="Lista de Cargos">
        </form><br>

        <form class="center" action="/LibreriaCientifica/Cargo/inserta_cargo.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Cargo">
        </form><br>
        <form class="center" action="/LibreriaCientifica/Cargo/update_cargo.jsp">
            <input type="submit" class=" opc opc-green" value="Actualiza Cargo">
        </form>
