...
<main class="main">
    <div class="container">
        <br/><h1>Cliente</h1>
        <p>Esa persona es nuestra mayor prioridad, es aquel sujeto interesado en hacer la compra de alguno de nuestros libros, puede ser frecuente o tal vez no.</p>
        <br>
        <form class="center" action="/LibreriaCientifica/Cliente/cliente.jsp">
            <input type="submit" class=" opc opc-green" value="Lista de Clientes">
        </form><br>

        <form class="center" action="/LibreriaCientifica/Cliente/inserta_cliente.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Cliente">
        </form><br>
        <form class="center" action="/LibreriaCientifica/Cliente/update_cliente.jsp">
            <input type="submit" class=" opc opc-green" value="Actualiza Cliente">
        </form><br>
        <form class="center" action="/LibreriaCientifica/Cliente/elimina_cliente.jsp">
