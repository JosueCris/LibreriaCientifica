...
<main class="main">
    <div class="container">
        <br/><h1>Editorial</h1>
        <p>Es la empresa encargada de la producción, publicación y promoción de libros, autores, revistas o periódicos.</p>
        <br>
        <form class="center" action="/LibreriaCientifica/Editorial/editorial.jsp">
            <input type="submit" class=" opc opc-green" value="Lista de Editoriales">
        </form><br>

        <form class="center" action="/LibreriaCientifica/Editorial/inserta_editorial.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Editorial">
        </form><br>
        <form class="center" action="/LibreriaCientifica/Editorial/update_editorial.jsp">
            <input type="submit" class=" opc opc-green" value="Actualiza Editorial">
        </form><br>
        <form class="center" action="/LibreriaCientifica/Editorial/elimina_editorial.jsp">
            <input type="submit" class=" opc opc-green" value="Elimina Editorial">
        </form>
    </div><br>
</main>
