...
<main class="main">
    <div class="container">
        <br/><h1>Nota Venta</h1>
        <p>Cada vez que se hace una transacción, la librería tiene la obligación de entregar un comprobante de la compra que se hizo, a esto se le llama nota de venta, puede ser sencilla o factura.</p>
        <br>
        <form class="center" action="/LibreriaCientifica/NotaVenta/notaventa.jsp">
            <input type="submit" class=" opc opc-green" value="Lista de Notas">
        </form><br>

        <form class="center" action="/LibreriaCientifica/NotaVenta/inserta_notaventa.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Nota">
        </form><br>
        <form class="center" action="/LibreriaCientifica/NotaVenta/update_notaventa.jsp">
            <input type="submit" class=" opc opc-green" value="Actualiza Nota">
        </form><br>
        <form class="center" action="/LibreriaCientifica/NotaVenta/elimina_notaventa.jsp">
            <input type="submit" class=" opc opc-green" value="Elimina Nota">
        </form>
    </div><br>
</main>
